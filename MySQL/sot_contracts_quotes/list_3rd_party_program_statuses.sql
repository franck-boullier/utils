...
# - Create a table `list_3rd_party_program_statuses_logs` to log all the changes in the table.
...
# - Logs of each changes in this table are recorded in the table `list_3rd_party_program_statuses_logs`
#
...
# Create the table `list_3rd_party_program_statuses_logs` to store the changes in the data
CREATE TABLE `list_3rd_party_program_statuses_logs` (
...
# The information will be stored in the table `list_3rd_party_program_statuses_logs`
...
FOR EACH ROW
BEGIN
  INSERT INTO `list_3rd_party_program_statuses_logs` (
    `action`, 
    `action_datetime`, 
    `uuid`, 
...
INSERT  INTO `list_3rd_party_program_statuses`(
    ...
    VALUES 
        (@UUID_sql_script, 0, 0, 0, 'UNKNOWN','We have no information about the 3rd party program status. This is an INACTIVE Status'),
        (@UUID_sql_script, 0, 0, 0, 'PENDING','The 3rd party program has NOT been create yet. This is an INACTIVE Status'),
        (@UUID_sql_script, 0, 0, 1, 'ACTIVE','The 3rd party program is up and running. This is an ACTIVE Status'),
        (@UUID_sql_script, 0, 0, 1, 'SUNSET','The 3rd party program is accepting our products but we should NOT create new product for this 3rd party program. This is an INACTIVE Status'),
        (@UUID_sql_script, 0, 0, 0, 'INACTIVE','The 3rd party program is inactive. This is an INACTIVE Status'),
